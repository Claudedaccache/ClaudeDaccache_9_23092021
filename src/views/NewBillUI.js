          ...
          <form data-testid="form-new-bill">
            <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-half" id="addFees">
                    <div class="flex-col"> 
                      <label for="vat" class="bold-label">TVA</label>
                      <input type="number" class="form-control blue-border vat" data-testid="vat" placeholder="70" />
                    </div>
                    <div class="flex-col">
                      <label for="pct" class="white-text">%</label>
                      <input required type="number" class="form-control blue-border pct" data-testid="pct" placeholder="20" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" data-testid="btn-send" id='btn-send-bill' class="btn btn-primary">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
