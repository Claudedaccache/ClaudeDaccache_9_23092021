...
export const cards = (bills) => {
  const antiChrono = (a, b) => {
    return new Date(b.date) - new Date(a.date); ///sorted dated///
  };
  ...
  handleClickIconEye = () => {
    ...
    if (
      ...
      $("#modaleFileAdmin1")
        .find(".modal-body")
        .html(
          `<h6 style='text-align: center;'> Extension pas respecter!!</h6>`
        ); /// replaced ${imgWidth} with 100%///
      if (typeof $("#modaleFileAdmin1").modal === "function")
        $("#modaleFileAdmin1").modal("show");
    } else {
      // const imgWidth = Math.floor($('#modaleFileAdmin1').width() * 0.8) ///removed///
      $("#modaleFileAdmin1")
        .find(".modal-body")
        .html(
          `<div style='text-align: center;'><img width=100% src=${billUrl} /></div>`
        ); /// replaced ${imgWidth} with 100%///
      if (typeof $("#modaleFileAdmin1").modal === "function")
        $("#modaleFileAdmin1").modal("show");
    }
